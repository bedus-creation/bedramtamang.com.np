    ...
    <div class="container mx-auto px-2">
        <div class="flex justify-between font-semibold whitespace-no-wrap overflow-x-auto overflow-y-hidden py-2">
            ...
            <div class="flex">
                ...
                <div class="pl-3 py-3">Who I am ?</div>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="px-6 py-4 flex justify-center py-1">
                <div class="text-center">
                    ...
                    <div class="text-justify text-grey-darker leading-normal my-6">
                        Hello, I am <a href="https://twitter.com/tmg_bedus" target="_blank">@Bedram Tamang</a>, I am a Software 
                        Architect, Developer, Freelancer with more than 4 years of experience in the web development field, 
                        passionate for cutting edge technology. My core objective is to understand the business need and design
