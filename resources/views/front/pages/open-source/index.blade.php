        ...
        <div class="md:flex md:-mx-4">
            <div class="w-full md:w-1/3 md:mx-4">
                <div class="w-full rounded overflow-hidden shadow-lg">
                    ...
                    <div class="px-6 py-4">
                        <a href="https://blog.jobins.jp/simplifying-form-handling-in-vue-applications-with-formjs" target="_blank">
                            <div class="font-bold text-xl mb-2">formjs</div>
                        </a>
                        <p class="text-gray-700 text-base">
                            Formjs is a wrapper around axios and Form helper for vue.
                        </p>
                    </div>
                    <div class="px-6 py-4">
