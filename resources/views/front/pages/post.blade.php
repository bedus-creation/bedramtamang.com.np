    ...
    <div class="container">
        <div class="mx-auto w-3/4">
            ...
            <div class="flex items-center">
                ...
                <svg aria-hidden="true" data-prefix="fas" data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512" class="fill-current h-4 w-4  tw-font-16 text-dark">
                    <path fill="currentColor"
