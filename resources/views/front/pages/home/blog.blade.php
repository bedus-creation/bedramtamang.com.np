<a href="{{$item->link()}}" @if($item->external_link) target="_blank" @endif title="{{$item->title}}">
    <div class="w-full lg:flex mb-3">
        ...
        <div class="bg-white w-full rounded-b-lg lg:rounded-b-none lg:rounded-r-lg p-4 flex flex-col justify-between leading-normal">
            <div class="mb-8">
